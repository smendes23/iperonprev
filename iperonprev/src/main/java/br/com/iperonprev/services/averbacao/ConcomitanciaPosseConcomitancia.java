...
public class ConcomitanciaPosseConcomitancia implements TemposConcomitanteUmaAverbacao{
	...
	public boolean verificaConcomitancia(Averbacao a1) {
		try{
			if(a1.getNUMR_pessoasFuncionais().getDATA_efetivoExercicio().compareTo(a1.getDATA_fimConcomitancia()) < 0 || 
					a1.getNUMR_pessoasFuncionais().getDATA_efetivoExercicio().compareTo(a1.getDATA_fimConcomitancia()) == 0){
