...
public class ConcomitanciaAdmissaoDemissao implements TemposConcomitantesDuasAverbacoes{
	...
	public boolean verificaConcomitancia(Averbacao a1,int diasPeriodo1,Averbacao a2,int diasPeriodo2) {
		try {
			...
			if (a1.getDATA_admissao().compareTo(a2.getDATA_admissao()) == -1 && a1.getDATA_demissao().compareTo(a2.getDATA_demissao()) == 1 ){
			...
			System.out.println("Concomitancia Data Inicio e Fim");
		}
