...
public class Fevereiro implements FinanceiroPorMes{
	...
	public FinanceiroPorMesDto devolvePeriodo(String competencia, BigDecimal valor) {
		...
		if (Integer.parseInt(competencia.substring(0, 2)) == 2) {
			fr.setFev(df.formatterToCurrencyBrazilianWithoutSymbol(valor));
			return fr;
		}
