...
public class Janeiro implements FinanceiroPorMes{
	...
	public FinanceiroPorMesDto devolvePeriodo(String competencia, BigDecimal valor) {
		if (Integer.parseInt(competencia.substring(0, 2)) == 1) {
			fr.setJan(df.formatterToCurrencyBrazilianWithoutSymbol(valor));
			return fr;
		}
