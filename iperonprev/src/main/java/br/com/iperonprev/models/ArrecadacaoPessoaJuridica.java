...
@Entity
public class ArrecadacaoPessoaJuridica implements Serializable{
	...
	public List<DeducaoArrecadacaoPJ> getREL_deducao() {
		return REL_deducao;
	}
	public void setREL_deducao(List<DeducaoArrecadacaoPJ> rEL_deducao) {
		REL_deducao = rEL_deducao;
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArrecadacaoPessoaJuridica other = (ArrecadacaoPessoaJuridica) obj;
